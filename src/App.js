        ...
        firebase
            ...
            .then(res => {
                firebase
                    .database()
                    .ref(
                        `${process.env.REACT_APP_FIREBASE_ANON}/${res.user.uid}`
                    )
                    .set(true);
            ...
            <main id="home" style={{ paddingTop: 80 }}>
                ...
                <section className="clusters" id="clusters">
                    <Suspense fallback={<Loading />}>
                        <Clusters
                            onEnterViewport={() => onEnter("clusters")}
                            onLeaveViewport={() => onLeave("clusters")}
                        />
                    </Suspense>
                </section>
                ...
                <section className="samahanTv" id="samahanTv">
                    ...
                    <Suspense fallback={<Loading />}>
                        <Tv
                            onEnterViewport={() => onEnter("tv")}
                            onLeaveViewport={() => onLeave("tv")}
                        />
                    </Suspense>
                </section>
                <section className="fiestaTWG" id="fiestaTWG">
                    ...
                    <Suspense fallback={<Loading />}>
                        <TWG
                            onEnterViewport={() => onEnter("twg")}
                            onLeaveViewport={() => onLeave("twg")}
                        />
                    </Suspense>
                </section>
